...
logging.basicConfig(filename='TQ5_Zone3.log', filemode='w',format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S', encoding='utf-8', level=logging.INFO)
#logging.debug('This message should go to the log file')
logging.info('Reading & Storing TQ5 Zone3 Air Quality to csv successfully!')
